...
<div class="container-fluid py-5">
    <div class="editformlabl  ">
        <div class="form-floating editlabel mb-3">
          ...
          <div class="form-floating editlabel mb-3">
            <select class="form-select" id="SelectReason" aria-label="Floating label select example">
              <option selected>Amergency</option>
    ...
    <div class="editformlabl  ">
        ...
        <div class="form-floating editlabel mb-3">
            <input type="time" class="form-control" id="atime" placeholder="e.g: 10:00 PM">
