...
if(isset($_POST['submit'])) {
  ...
  $sql = "SELECT * FROM patientsignup WHERE email='$email' AND password='$password'";
...
<head>
    ...
    <title>Patient LoginPage</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="patientloginp.css">
</head>
<body>
    ...
    <div class="pb-5 text-center">
        <h1 class="portalheadedit">Login Patient</h1>
        ...
        <form method="POST" action="">        
            ...
            <div class="form-floating mb-3">
              ...
              <div>
                <p class="text-secondary">Do you want to <a  href="patientsignup.php"><span class="text-primary">Signup</span></a> ?</p>
              </div>

              <div>
                <!-- <a type="button" class="btn btn-outline-danger mt-3 w-50" href="patienthome.html">Login</a> -->
